...
class Configuration(object):
    ...
    def parse_cmd():
        ...
        # RNN Model
        parser.add_argument('--rnn' , action='store_true', help="Train RNN")
        parser.add_argument('--lstm' , action='store_true', help="Train LSTM")
        parser.add_argument('--hidden_dim', type=int, default=256, help='RNN/LSTM hidden dimension size')
        parser.add_argument('--num_layers', type=int, default=1, help='Number of RNN/LSTM cells')
